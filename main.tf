provider "aws" {
    ...
    access_key = "AKIASWXXJYNXBMIIMBO5"
    secret_key = "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"
}
...
resource "aws_instance" "web-server-instance" {
  ...
  # commands that run when the Ubuntu is creating
  user_data = <<-EOF
                #!/bin/bash
                sudo apt update -y
